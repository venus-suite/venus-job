...
import io.suite.venus.job.admin.mapper.XxlJobRegistryMapper;
...
public class AdminBizImpl implements AdminBiz {
    ...
    private ReturnT<String> callback(HandleCallbackParam handleCallbackParam) {
        ...
        if (log == null) {
            logger.info("log item not found {}",handleCallbackParam.getLogId());
    ...
    public ReturnT<String> registry(RegistryParam registryParam) {
        int ret = xxlJobRegistryMapper.registryUpdate(registryParam.getRegistGroup(),
                registryParam.getNamespace(),
                registryParam.getRegistryKey(),
                registryParam.getRegistryValue());
        if (ret < 1) {
            xxlJobRegistryMapper.registrySave(registryParam.getRegistGroup(),registryParam.getNamespace(),
                    registryParam.getRegistryKey(), registryParam.getRegistryValue());
        }
        return ReturnT.SUCCESS;
    }
    ...
    public ReturnT<String> registryRemove(RegistryParam registryParam) {
        xxlJobRegistryMapper.registryDelete(registryParam.getRegistGroup(),registryParam.getNamespace(),
                registryParam.getRegistryKey(), registryParam.getRegistryValue());
        return ReturnT.SUCCESS;
    }
