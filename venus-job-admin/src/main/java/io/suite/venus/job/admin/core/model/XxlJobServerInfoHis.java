...
@ApiModel(value = "xxl_job_server_info_his", description = "定时任务服务信息历史记录表")
@Entity
@Table(name = "xxl_job_server_info_his")
public class XxlJobServerInfoHis implements Serializable {
